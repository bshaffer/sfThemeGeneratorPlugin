...
class sfModuleGeneratorTasksCleanup
{
  protected $modules;
  ...
  {
    return sfFinder::type('dir')->maxdepth(0)->in(dirname(__FILE__).'/../../fixtures/project/apps/frontend/modules');
  }
}
$cleanup = new sfModuleGeneratorTasksCleanup();
$cleanup->cleanup();
