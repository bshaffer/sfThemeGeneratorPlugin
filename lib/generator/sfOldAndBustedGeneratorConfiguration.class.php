 ...
 * This code has been largely copied from sfModelGeneratorConfiguration
 * but has been renamed in order to be refactored out entirely
 *
 * @package    symfony
 ...
 */
abstract class sfOldAndBustedGeneratorConfiguration
{
  protected
    $configuration = array();
